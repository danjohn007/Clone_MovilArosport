...
const TieBreak2 = ({
  ...
  const validarPuntaje = (canchaIndex, pareja1, pareja2) => {
    ...
    if ((p1 < 5 && p2 < 5)) {
      return "Uno de los equipos debe tener 5 puntos.";
    }
                    ...
                    <View style={styles.inputsRow}>
                      <TextInput
                        ...
                        onChangeText={(text) => {
                          ...
                          handleChange(p.canchaIndex, "pareja1", sanitized);
                        }}
                        maxLength={1}
                      />
                      ...
                      <TextInput
                        ...
                        onChangeText={(text) => {
                          const sanitized = text.replace(/[^0-5]/g, "").slice(0, 1);
                          handleChange(p.canchaIndex, "pareja2", sanitized);
                        }}
                        maxLength={1}
                      />
                    </View>
